...
public class AppSession {
    ...
    public static boolean put(final String key, final String value) {
        ...
        SharedPreferences.Editor editor = MainApplication.getAppContext().getSharedPreferences(SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE).edit();
    ...
    public void putTaskList(String key, HashMap<Integer, Boolean> Taskmap) {
        ...
        SharedPreferences.Editor editor = MainApplication.getAppContext().getSharedPreferences(SHARED_PREFERENCE_NAME + "HashMap", Context.MODE_PRIVATE).edit();
    ...
    public HashMap<String, Boolean> getTaskList(String key) {
        ...
        SharedPreferences pref = MainApplication.getAppContext().getSharedPreferences(SHARED_PREFERENCE_NAME + "HashMap", Context.MODE_PRIVATE);
        ...
        for (String s : map.keySet()) {
            ...
            String KEY = s.substring(key.toString().length());
    ...
    public static String get(final String key) {
        SharedPreferences savedSession = MainApplication.getAppContext().getSharedPreferences(SHARED_PREFERENCE_NAME, Context.MODE_PRIVATE);
