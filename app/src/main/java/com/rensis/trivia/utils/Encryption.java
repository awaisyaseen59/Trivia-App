...
public class Encryption extends BaseClass {
    ...
    public static final String K = MainApplication.getAppContext().getString(R.string.key);
    public static final String S = MainApplication.getAppContext().getString(R.string.salt);
